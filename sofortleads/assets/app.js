...
var SL = {"stufen":[{"ab":100,"proz":30},{"ab":40,"proz":20},{"ab":20,"proz":10}],"themen":[{"id":"kapitalanleger","slug":"kapitalanleger-leads-kaufen","name":"Kapitalanleger","branche":"immobilienmakler","preis":270,"preisMin":189,"prov":9000,"quote":20,"provLabel":"Provision je Abschluss","bundesweit":false},{"id":"finanzierung","slug":"immobilienfinanzierung-leads-kaufen","name":"Immobilienfinanzierung","branche":"immobilienmakler","preis":60,"preisMin":45,"prov":2200,"quote":18,"provLabel":"Provision je Finanzierung","bundesweit":false},{"id":"verkaeufer","slug":"immobilien-verkaeufer-leads-kaufen","name":"Verk\u00e4ufer und Eigent\u00fcmer","branche":"immobilienmakler","preis":350,"preisMin":290,"prov":12000,"quote":15,"provLabel":"Provision je Verkaufsauftrag","bundesweit":false},{"id":"sterbegeld","slug":"sterbegeld-leads-kaufen","name":"Sterbegeldversicherung","branche":"versicherungsmakler","preis":45,"preisMin":30,"prov":600,"quote":22,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"motorrad-unfall","slug":"motorrad-unfallversicherung-leads-kaufen","name":"Motorrad-Unfallversicherung","branche":"versicherungsmakler","preis":60,"preisMin":45,"prov":450,"quote":20,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"kinder-gesundheit","slug":"kinder-gesundheitsvorsorge-leads-kaufen","name":"Gesundheitsvorsorge f\u00fcr Kinder","branche":"versicherungsmakler","preis":60,"preisMin":45,"prov":700,"quote":18,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"kfz","slug":"kfz-versicherung-leads-kaufen","name":"Kfz-Versicherung","branche":"versicherungsmakler","preis":40,"preisMin":25,"prov":180,"quote":28,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"zahnzusatz","slug":"zahnzusatzversicherung-leads-kaufen","name":"Zahnzusatzversicherung","branche":"versicherungsmakler","preis":50,"preisMin":30,"prov":520,"quote":22,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"edelmetalle","slug":"edelmetall-leads-kaufen","name":"Edelmetalle und Sachwerte","branche":"finanzberater","preis":80,"preisMin":55,"prov":1400,"quote":16,"provLabel":"Marge je Abschluss","bundesweit":false},{"id":"kindersparplan","slug":"kindersparplan-leads-kaufen","name":"Kindersparplan","branche":"finanzberater","preis":60,"preisMin":45,"prov":750,"quote":20,"provLabel":"Courtage je Abschluss","bundesweit":false},{"id":"kredit","slug":"kredit-leads-kaufen","name":"Kreditvermittlung","branche":"finanzberater","preis":60,"preisMin":30,"prov":1800,"quote":14,"provLabel":"Provision je Vermittlung","bundesweit":false},{"id":"partner-recruiting","slug":"vertriebspartner-leads-kaufen","name":"Vertriebspartner und Nebeneinkommen","branche":"direktvertrieb","preis":45,"preisMin":30,"prov":1500,"quote":12,"provLabel":"Ertrag je aktivem Partner im ersten Jahr","bundesweit":true},{"id":"gewicht","slug":"abnehmen-leads-kaufen","name":"Gewichtsreduktion","branche":"direktvertrieb","preis":35,"preisMin":25,"prov":220,"quote":25,"provLabel":"Deckungsbeitrag je Kunde","bundesweit":true},{"id":"nahrungsergaenzung","slug":"nahrungsergaenzung-leads-kaufen","name":"Gesundheit und Nahrungserg\u00e4nzung","branche":"direktvertrieb","preis":35,"preisMin":25,"prov":200,"quote":25,"provLabel":"Deckungsbeitrag je Kunde","bundesweit":true},{"id":"kosmetik","slug":"kosmetik-leads-kaufen","name":"Anti-Aging und Kosmetik","branche":"direktvertrieb","preis":35,"preisMin":25,"prov":190,"quote":24,"provLabel":"Deckungsbeitrag je Kunde","bundesweit":true},{"id":"photovoltaik","slug":"photovoltaik-leads-kaufen","name":"Photovoltaik und Speicher","branche":"energie","preis":110,"preisMin":90,"prov":2600,"quote":18,"provLabel":"Deckungsbeitrag je Anlage","bundesweit":false},{"id":"waermepumpe","slug":"waermepumpe-leads-kaufen","name":"W\u00e4rmepumpe und Heizung","branche":"energie","preis":130,"preisMin":110,"prov":3200,"quote":16,"provLabel":"Deckungsbeitrag je Auftrag","bundesweit":false},{"id":"klima","slug":"klimaanlage-leads-kaufen","name":"Klimaanlage","branche":"energie","preis":120,"preisMin":95,"prov":1500,"quote":20,"provLabel":"Deckungsbeitrag je Auftrag","bundesweit":false}]};
...
// Direktvertrieb liefert deutschlandweit (Bernd 11.09.2026): dort entfaellt der Gebietsschritt.
function kBundesweit(){var t=findThema(el('f-thema').value);return !!(t&&t.bundesweit);}
function kGebietText(){
  if(kBundesweit())return 'Deutschland, bundesweit';
  var plz=kWert('f-plz');
  return plz?(plz+', '+(el('f-radius').value==='0'?'bundesweit':el('f-radius').value+' km')):'noch offen';
}
function kWeiter2(){
  kFehler('err2','');
  kCalc();
  if(kBundesweit()){kWeiter3();return;}
  kGo(3);
}
function kZurueckVonPruefung(){kGo(kBundesweit()?2:3);}
function kWeiter3(){
  var plz=kWert('f-plz');
  if(!kBundesweit()&&!/^[0-9]{5}$/.test(plz)){kFehler('err3','Bitte geben Sie eine f\u00fcnfstellige Postleitzahl an.');el('f-plz').classList.add('invalid');return;}
  kFehler('err3','');
  kCalc();
...
function kAbsenden(){
  ...
  kSende('sl-portal-order',{
    ...
    plz:kBundesweit()?'':kWert('f-plz'),radius:kBundesweit()?'0':el('f-radius').value,gebiet:kGebietText(),zeitraum:el('f-zeitraum').value
  });
  kGo(5);
}
...
function kCalc(){
  ...
  el('s-gebiet').textContent=kGebietText();
  var b2=el('k-weiter2');if(b2)b2.textContent=kBundesweit()?'Weiter zur Bestell\u00fcbersicht':'Weiter zum Gebiet';
...
function rcalc(){
  ...
  // Vertriebspartner (Jens 11.09.2026): keine angenommene Quote, nur die Gewinnschwelle zeigen, wie auf /direktvertrieb-meta/.
  var partner=(t.id==='partner-recruiting');
  el('r-quote').parentNode.style.display=partner?'none':'';
  el('r-umsatz').parentNode.style.display=partner?'none':'';
  el('r-erg').parentNode.style.display=partner?'none':'';
  el('b-ums').parentNode.parentNode.style.display=partner?'none':'';
  el('b-erg').parentNode.parentNode.style.display=partner?'none':'';
  el('r-abs').previousElementSibling.textContent=partner?'Aktive Partner bis zur Gewinnschwelle':'Erwartete Abschl\u00fcsse';
  if(partner){
    el('r-abs').textContent=noetig;
    el('r-break').innerHTML=(noetig===1?'Schon <b>1 aktiver Partner</b>':'<b>'+noetig+' aktive Partner</b>')+' aus '+n+' Leads '+(noetig===1?'tr\u00e4gt':'tragen')+' das gesamte Paket.';
  }
